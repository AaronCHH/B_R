---
title: "Chapter 13. Miscellaneous Graphs"
...
- [Chapter 13. Miscellaneous Graphs](#chapter-13-miscellaneous-graphs)
	- [13.1. Making a Correlation Matrix](#131-making-a-correlation-matrix)
	- [13.2. Plotting a Function](#132-plotting-a-function)
	- [13.3. Shading a Subregion Under a Function Curve](#133-shading-a-subregion-under-a-function-curve)
	- [13.4. Creating a Network Graph](#134-creating-a-network-graph)
	- [13.5. Using Text Labels in a Network Graph](#135-using-text-labels-in-a-network-graph)
	- [13.6. Creating a Heat Map](#136-creating-a-heat-map)
	- [13.7. Creating a Three-Dimensional Scatter Plot](#137-creating-a-three-dimensional-scatter-plot)
	- [13.8. Adding a Prediction Surface to a Three-Dimensional Plot](#138-adding-a-prediction-surface-to-a-three-dimensional-plot)
	- [13.9. Saving a Three-Dimensional Plot](#139-saving-a-three-dimensional-plot)
	- [13.10. Animating a Three-Dimensional Plot](#1310-animating-a-three-dimensional-plot)
	- [13.11. Creating a Dendrogram](#1311-creating-a-dendrogram)
	- [13.12. Creating a Vector Field](#1312-creating-a-vector-field)
	- [13.13. Creating a QQ Plot](#1313-creating-a-qq-plot)
	- [13.14. Creating a Graph of an Empirical Cumulative Function](#1314-creating-a-graph-of-an-empirical-cumulative-function)
	- [13.15. Creating a Mosaic Plot](#1315-creating-a-mosaic-plot)
	- [13.16. Creating a Pie Chart](#1316-creating-a-pie-chart)
	- [13.17. Creating a Map](#1317-creating-a-map)
	- [13.18. Creating a Choropleth Map](#1318-creating-a-choropleth-map)
	- [13.19. Making a Map with a Clean Background](#1319-making-a-map-with-a-clean-background)
	- [13.20. Creating a Map from a Shapefile](#1320-creating-a-map-from-a-shapefile)
...
## 13.14. Creating a Graph of an Empirical Cumulative Function
* **Problem**  
