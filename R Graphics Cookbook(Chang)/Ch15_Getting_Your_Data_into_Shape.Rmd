---
title: "Chapter 15. Getting Your Data into Shape"
...
- [Chapter 15. Getting Your Data into Shape](#chapter-15-getting-your-data-into-shape)
	- [15.1. Creating a Data Frame](#151-creating-a-data-frame)
	- [15.2. Getting Information About a Data Structure](#152-getting-information-about-a-data-structure)
	- [15.3. Adding a Column to a Data Frame](#153-adding-a-column-to-a-data-frame)
	- [15.4. Deleting a Column from a Data Frame](#154-deleting-a-column-from-a-data-frame)
	- [15.5. Renaming Columns in a Data Frame](#155-renaming-columns-in-a-data-frame)
	- [15.6. Reordering Columns in a Data Frame](#156-reordering-columns-in-a-data-frame)
	- [15.7. Getting a Subset of a Data Frame](#157-getting-a-subset-of-a-data-frame)
	- [15.8. Changing the Order of Factor Levels](#158-changing-the-order-of-factor-levels)
	- [15.9. Changing the Order of Factor Levels Based on Data Values](#159-changing-the-order-of-factor-levels-based-on-data-values)
	- [15.10. Changing the Names of Factor Levels](#1510-changing-the-names-of-factor-levels)
	- [15.11. Removing Unused Levels from a Factor](#1511-removing-unused-levels-from-a-factor)
	- [15.12. Changing the Names of Items in a Character Vector](#1512-changing-the-names-of-items-in-a-character-vector)
	- [15.13. Recoding a Categorical Variable to Another Categorical Variable](#1513-recoding-a-categorical-variable-to-another-categorical-variable)
	- [15.14. Recoding a Continuous Variable to a Categorical Variable](#1514-recoding-a-continuous-variable-to-a-categorical-variable)
	- [15.15. Transforming Variables](#1515-transforming-variables)
	- [15.16. Transforming Variables by Group](#1516-transforming-variables-by-group)
	- [15.17. Summarizing Data by Groups](#1517-summarizing-data-by-groups)
	- [15.18. Summarizing Data with Standard Errors and Intervals](#1518-summarizing-data-with-standard-errors-and-intervals)
	- [15.19. Converting Data from Wide to Long](#1519-converting-data-from-wide-to-long)
	- [15.20. Converting Data from Long to Wide](#1520-converting-data-from-long-to-wide)
	- [15.21. Converting a Time Series Object to Times and Values](#1521-converting-a-time-series-object-to-times-and-values)
	- [Appendix A. Introduction to ggplot2](#appendix-a-introduction-to-ggplot2)
...
## 15.18. Summarizing Data with Standard Errors and Intervals
* **Problem**  
