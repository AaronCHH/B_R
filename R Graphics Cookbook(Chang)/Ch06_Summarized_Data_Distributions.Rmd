---
title: "Chapter 6. Summarized Data Distributions"
...
- [Chapter 6. Summarized Data Distributions](#chapter-6-summarized-data-distributions)
	- [6.1. Making a Basic Histogram](#61-making-a-basic-histogram)
	- [6.2. Making Multiple Histograms from Grouped Data](#62-making-multiple-histograms-from-grouped-data)
	- [6.3. Making a Density Curve](#63-making-a-density-curve)
	- [6.4. Making Multiple Density Curves from Grouped Data](#64-making-multiple-density-curves-from-grouped-data)
	- [6.5. Making a Frequency Polygon](#65-making-a-frequency-polygon)
	- [6.6. Making a Basic Box Plot](#66-making-a-basic-box-plot)
	- [6.7. Adding Notches to a Box Plot](#67-adding-notches-to-a-box-plot)
	- [6.8. Adding Means to a Box Plot](#68-adding-means-to-a-box-plot)
	- [6.9. Making a Violin Plot](#69-making-a-violin-plot)
	- [6.10. Making a Dot Plot](#610-making-a-dot-plot)
	- [6.11. Making Multiple Dot Plots for Grouped Data](#611-making-multiple-dot-plots-for-grouped-data)
	- [6.12. Making a Density Plot of Two-Dimensional Data](#612-making-a-density-plot-of-two-dimensional-data)
